...
تم تطوير وبرمجه السورس بواسطه مصطفي دندشه
...
sudo_users = {SUDO,1135359831,1135359831,1321555749,1321555749,1321555749,1135359831}   
...
local Text =[[
[⋆](t.me/php_14) ━━━━━━[✿](t.me/php_14)━━━━━━ [⋆](t.me/php_14)      
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙾𝙵𝙵𝙻𝙸𝙽𝙴 ',url="t.me/X_x_O_F_F_L_I_N_E_x_X"},{text = '𝙰𝙻𝙰𝚉𝙸𝚉𝚈',url="t.me/alazizy"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙾𝙵𝙵𝙻𝙸𝙽𝙴 ',url="t.me/X_x_O_F_F_L_I_N_E_x_X"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,"⋆ عذرا الملف لايلب سوبر سورس دندشه \n") 
end
return false
end
